"""Binary sensor platform for zeptrion_air."""
...
ENTITY_DESCRIPTIONS = (
    BinarySensorEntityDescription(
        key="zeptrion_air",
        name="Zeptrion Air Binary Sensor",
...
class ZeptrionAirBinarySensor(ZeptrionAirEntity, BinarySensorEntity):
    """zeptrion_air binary_sensor class."""
